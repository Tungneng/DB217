...
function win(userChoice, compChoice) {
  ...
  `${userChoice.toUpperCase()} ชนะ` + 
  `${compChoice.toUpperCase()}. เก่งแต่กับบอทมึงอะ`;
...
function loses(userChoice, compChoice) {
  ...
  result_div.innerHTML = 
  `${userChoice.toUpperCase()} ฮื่อ ฉันแพ้แล้ว` + 
  `${compChoice.toUpperCase()}. ไงล่ะไอขี้แพ้`;
...
function draw(choice) {
  ...
  result_div.innerHTML =
  `เสมอจ้าาา` +
  `เพราะเตงเลือก ${choice.toUpperCase()}`;
}
